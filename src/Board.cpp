...
//    if(computerIsMax)
//    {
        return board.getPlayer(1).getScore()- board.getPlayer(2).getScore() ;//+ (board.getPlayer(1).getPiecesLeft()*5-board.getPlayer(2).getPiecesLeft()*5);
//    }
//    else
//    {
//        return board.getPlayer(2).getScore()- board.getPlayer(1).getScore()+ (board.getPlayer(2).getPiecesLeft()*5-board.getPlayer(1).getPiecesLeft()*5);
//    }
}
...
//extern pair<board,int>  minimax2(Board board, int depth,bool isComputerMax,int alpha,int beta)
//{
//
//
//    cout<<depth<<endl;
...
//    if (depth==0 || board.isGameOver())
//    {
//        return make_pair(board,evaluate(board,isComputerMax));
//    }
//
//
//
...
//            board = board.make_move(m.first,m.second,board);
//
//            pair<Board,int>  out = minimax(board,depth-1,false,alpha,beta);
//
//            //int current_eval = out.second;
//
//            current_eval = max(out.second,current_eval);
...
//            board = board.make_move(m.first,m.second,board);
//
//            pair<Board,int>  out = minimax(board,depth-1,true,alpha,beta);
//
//            current_eval = min(out.second,current_eval);
//
//            board = temp_board;
